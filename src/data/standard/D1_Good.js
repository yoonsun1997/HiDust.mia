...
import {ReactComponent as Good}  from '../standard/good.svg';
        ...
        <>
            <div className={`${styles.DustStateSection}`}>
                ...
                <div className={`${styles.SectionTitle}`}>
                    <h1><Good />
                        <br/>
                        <span className={`${styles.State}`}>좋음</span>
                        </h1>
                    <h1 className={`${styles.h2}`}>미세먼지<br />(PM-10)</h1>
                    <h1 className={`${styles.GoodAmount}`}>{area.areaData.pm10Value ||'---'}㎍/㎥</h1>
                </div>
                <div className={`${styles.SubTitle}`}>
                    <div>
                        <h2 className={`${styles.h2}`}>이산화질소(NO₂)</h2>
                        <h2 className={`${styles.SubLast}`}>{area.areaData.no2Value ||'---'}㎍/㎥</h2>
                    </div>
                    <div>
                        <h2 className={`${styles.h2}`}>일산화탄소(CO)</h2>
                        <h2 className={`${styles.SubLast}`}>{area.areaData.coValue ||'---'}ppm</h2>
                    </div>
                    <div>
                        <h2 className={`${styles.h2}`}>오존(O₃)</h2>
                        <h2 className={`${styles.SubLast}`}>{area.areaData.o3Value ||'---'}ppm</h2>
                    </div>
                    <div>
                        <h2 className={`${styles.h2}`}>아황산가스(SO₂)</h2>
                        <h2 className={`${styles.SubLast}`}>{area.areaData.so2Value ||'---'}ppm</h2>
                    </div>
                </div>
