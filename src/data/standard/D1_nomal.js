...
import styles from './nomal.module.css';
import {ReactComponent as Nomal}  from '../standard/nomal.svg';
    ...
    return(
        <>
            <div className={`${styles.DustStateSection}`}>
                ...
                <h1><Nomal />
                    <br/>
                    <span className={`${styles.NState}`}>보통</span>
                </h1>
                    <h1 className={`${styles.h2}`}>미세먼지<br />(PM-10)</h1>
                    <h1 className={`${styles.NomalAmount}`}>{area.areaData.pm10Value ||'---'}㎍/㎥</h1>
                </div>
